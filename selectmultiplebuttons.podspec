#
#  Be sure to run `pod spec lint selectmultiplebuttons.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Young" => "danceyoung@hotmail.com" }
  ...
  s.source       = { :git => "https://github.com/danceyoung/selectmultiplebuttons.git", :tag => "#{s.version}" }
